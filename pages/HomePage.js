...
import GeminiAIComponent from '../components/GeminiAIComponent.js'
...
const HomePage = () => {
 ...
 const [cart,setCart]=useCart()
  ...
  const [showGeminiChatbot, setShowGeminiChatbot] = useState(false);
  ...
  return (
    ...
    {/*   <GeminiAIComponent onClose={() => setShowGeminiChatbot(false)} />   */} 
    <button 
        className="gemini-icon"
        onClick={() => setShowGeminiChatbot(!showGeminiChatbot)}
      >
        {showGeminiChatbot ? 'X' : '🤖'}
      </button>
